...
def build_model(input_shape, num_classes, weights=None):
    ...
    base_model = NASNetLarge(weights=weights, include_top=False, input_shape=input_shape,
    ...
    model = Model(inputs=base_model.input, outputs=x, name='trained_from_scratch_NASNetLarge')
