...
def build_model(num_classes):
    ...
    gap3 = GlobalAveragePooling2D()(base_model.get_layer('block3_conv3').output)
    gap4 = GlobalAveragePooling2D()(base_model.get_layer('block4_conv3').output)
    gap5 = GlobalAveragePooling2D()(base_model.get_layer('block5_conv3').output)
